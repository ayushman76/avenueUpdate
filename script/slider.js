section = () => {
    ...
    var slider_jason = [{
        ...
        para: 'With a concrete belief in delivering the best software development solutions that can help your business carve a niche for itself in this tough competition, Code Fusion is the right source to turn your visions into a reality with total success. Offering a wide array of web and mobile outsourcing services such as Web development, Android development, iOS development, SEO Services, JS Programming, etc.|',
        btn: '8224973413'
    }, {
